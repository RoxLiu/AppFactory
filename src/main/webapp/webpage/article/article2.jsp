...
<t:formvalid formid="formobj" dialog="true" layout="table" action="articleController.do?saveArticle">
    ...
    <table style="width: 650px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                <input class="ke-input-text" type="text" id="url" value="${article.icon}" readonly="readonly" /> <input type="button" id="uploadButton" value="Upload" />
        ...
        <tr>
            ...
            <td class="value">
                <input class="inputxt" name="content" value="${article.content}">
                <%--<span class="Validform_checktip"/>--%>
            </td>
        </tr>
        <tr>
