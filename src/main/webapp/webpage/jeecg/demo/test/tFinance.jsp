...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" callback="@Override uploadFile" action="tFinanceController.do?save">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<t:upload name="fiels" id="file_upload" extend="*.doc;*.docx;*.txt;*.ppt;*.xls;*.xlsx;*.html;*.htm;*.pdf;" buttonText="添加文件" formData="financeId" uploader="tFinanceController.do?saveFiles">
			</t:upload>
				</div>
			</td>
		</tr>
