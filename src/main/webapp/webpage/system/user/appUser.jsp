...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveAppUser">
	...
	<table style="width: 650px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            <td align="right"><label class="Validform_label"> 模块: </label></td>
            <td class="value" nowrap>
                <input name="moduleId" type="hidden" value="${id}" id="moduleId">
                <input name="name" class="inputxt" value="${name}" id="name" readonly="readonly" datatype="*" />
                <t:choose hiddenName="moduleId" hiddenid="id" inputTextname="name" textname="name" url="userController.do?modules" name="moduleList" icon="icon-search" title="模块列表" isclear="true"/>
                <span class="Validform_checktip">模块可多选</span>
            </td>
        </tr>
