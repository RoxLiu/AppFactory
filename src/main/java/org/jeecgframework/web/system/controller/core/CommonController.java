...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = ConvertUtils.getString(request.getParameter("subclassname"), "org.jeecgframework.web.system.pojo.base.TSAttachment");
		...
		if ("dwg".equals(extend)) {
			String realpath = ConvertUtils.getString(reflectHelper.getMethodValue("realpath"));
	...
	public void viewFile(HttpServletRequest request, HttpServletResponse response) {
		String fileid = ConvertUtils.getString(request.getParameter("fileid"));
		String subclassname = ConvertUtils.getString(request.getParameter("subclassname"), "com.jeecg.base.pojo.TSAttachment");
		Class fileClass = MyClassLoader.getClassByScn(subclassname);// 附件的实际类
		Object fileobj = systemService.getEntity(fileClass, fileid);
		ReflectHelper reflectHelper = new ReflectHelper(fileobj);
		...
		String path = ConvertUtils.getString(reflectHelper.getMethodValue("realpath"));
		String extend = ConvertUtils.getString(reflectHelper.getMethodValue("extend"));
		String attachmenttitle = ConvertUtils.getString(reflectHelper.getMethodValue("attachmenttitle"));
	...
	public ModelAndView objfileList(HttpServletRequest request) {
		...
		String fileKey = ConvertUtils.getString(request.getParameter("fileKey"));// 文件ID
		TSAttachment attachment = systemService.getEntity(TSAttachment.class,fileKey);
		String businessKey = ConvertUtils.getString(request.getParameter("businessKey"));// 业务主键
		String busentityName = ConvertUtils.getString(request.getParameter("busentityName"));// 业务主键
		String typename = ConvertUtils.getString(request.getParameter("typename"));// 类型
		String typecode = ConvertUtils.getString(request.getParameter("typecode"));// 类型typecode
