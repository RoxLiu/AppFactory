...
public class CgformFtlController extends BaseController {
	...
	public AjaxJson saveWordFiles(HttpServletRequest request,
		...
		LogUtil.info("-------------------------step.1-------------------------------------");
		String fileKey = ConvertUtils.getString(request.getParameter("id"));// 文件ID
		String cgformId = ConvertUtils.getString(request
                .getParameter("cgformId"));// formid
		String cgformName = ConvertUtils.getString(request
                .getParameter("cgformName"));// formname
		String ftlStatus = ConvertUtils.getString(request
                .getParameter("ftlStatus"));// formStatus
		if (ConvertUtils.isEmpty(ftlStatus)) {
			ftlStatus = "0";
		}
	...
	public AjaxJson saveEditor(CgformFtlEntity cgformFtl,
		...
		String ftlVersion = ConvertUtils.getString(request
                .getParameter("ftlVersion"));
		String ftlWordUrl = ConvertUtils.getString(request
                .getParameter("ftlWordUrl"));
		String createBy = ConvertUtils.getString(request
                .getParameter("createBy"));
		String createName = ConvertUtils.getString(request
                .getParameter("createName"));
		String createDate = ConvertUtils.getString(request
