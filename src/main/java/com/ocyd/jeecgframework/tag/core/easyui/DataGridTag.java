package com.ocyd.jeecgframework.tag.core.easyui;
...
import com.ocyd.jeecgframework.tag.vo.easyui.ColumnValue;
import com.ocyd.jeecgframework.tag.vo.easyui.DataGridColumn;
import com.ocyd.jeecgframework.tag.vo.easyui.DataGridUrl;
import com.ocyd.appfactory.service.SystemService;

import net.sf.json.JSONObject;

import org.apache.commons.lang.StringUtils;
import com.ocyd.jeecgframework.tag.vo.easyui.OptTypeDirection;
...
//				}
	...
	public StringBuffer end() {
		...
		/**行记录赋值*/
		sb.append("rowid=rowData." + idField + ";");
...
//									sb.append("</select>");
	...
	public String getNoAuthOperButton(){
		...
		StringBuffer sb = new StringBuffer();
        //todo: 此处还要鉴权？？！！！
		if(ResourceUtil.getCurrentSessionUser().getAccountName().equals("admin")|| !Globals.BUTTON_AUTHORITY_CHECK){
		}else{
