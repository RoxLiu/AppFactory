...
import com.ocyd.jeecgframework.core.annotation.JeecgEntityTitle;
...
import com.ocyd.jeecgframework.core.common.exception.BusinessException;
...
import com.ocyd.jeecgframework.core.common.hibernate.qbc.PagerUtil;
...
import com.ocyd.jeecgframework.core.common.hibernate.qbc.DetachedCriteriaUtil;
import com.ocyd.jeecgframework.core.util.ToEntityUtil;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	 ...
	 * @param pojo
	 */
	public <T> void updateEntities(String className, Object id) {
